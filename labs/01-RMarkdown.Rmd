...
After creating the file, change `output: html_document` to `output: github_document` (this will make the document viewable on the GitHub website; otherwise it will appear as basically unreadable code). Save the file as `Introduction.Rmd`. Please do not deviate from this file name. If you've already screwed up and need to rename the file, check the file in the Files tab, click the Rename button, and do it right this time. 
